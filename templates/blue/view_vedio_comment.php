...
<title>视频评论 - <?php echo WEBPAGE_TITLE_SUFFIX;?></title>
...
<div class="f_frame">
<div class="f_crumbs">
<span class="f_crumbs_link"><a href="index.php">首页</a></span> &gt; <span class="f_crumbs_link"><a href="view.php?mode=article">视频列表</a></span> &gt; <span class="f_crumbs_link"><a href="detail.php?mode=vedio&id=<?php echo $row_vedio["id"];?>" title="<?php echo $row_vedio["title"];?>"><?php echo csubstr($row_vedio["title"], 16);?></a></span>&nbsp;<span style="font-size:12px;color:#AFB52F;">[评论]</span>
</div>
...
<input type="hidden" name="mode" value="vedio" />
</form>
</div>
<?php
