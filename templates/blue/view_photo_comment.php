...
<title>图片评论 - <?php echo WEBPAGE_TITLE_SUFFIX;?></title>
...
<div class="f_frame">
<div class="f_crumbs">
<span class="f_crumbs_link"><a href="index.php">首页</a></span> &gt; <span class="f_crumbs_link"><a href="view.php?mode=album">相册</a>:<a href="view.php?mode=photo&id=<?php echo $row_album["id"];?>" title="<?php echo $row_album["title"];?>"><?php echo csubstr($row_album["title"], 16);?></a></span> &gt; <span class="f_crumbs_link"><a href="detail.php?mode=photo&id=<?php echo $id;?>" title="<?php echo $row_photo["title"];?>"><?php echo csubstr($row_photo["title"], 16);?></a></span>&nbsp;<span style="font-size:12px;color:#AFB52F;">[评论]</span>
</div>
