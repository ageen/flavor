...
<?php
	...
	foreach($row_vedios as $k=>$v){
		...
		if($v["thumbnail"]!=""){
			$thumbimg = "uploads/vedio/thumbnail/".$v["thumbnail"];
		} else {
			$thumbimg = TEMPATH."images/no-logo.jpg";
		}
...
<?php
if($v["locked"]==1){
	if(isset($_SESSION["unlock"])&&in_array($v["id"], $_SESSION["unlock"])){
?>
<div class="vedio_list_thumb"><a href="detail.php?mode=vedio&id=<?php echo $v["id"];?>" title="<?php echo $v["title"];?>"><img class="lazy" src="<?php echo TEMPATH; ?>images/lightblue.gif" data-original="<?php echo $thumbimg;?>" height="200" width="200" /></a></div>
<?php
	} else {
?>
<div class="vedio_list_thumb"><a href="detail.php?mode=vedio&id=<?php echo $v["id"];?>" title="<?php echo $v["title"];?>"><img class="lazy" src="<?php echo TEMPATH; ?>images/lightblue.gif" data-original="<?php echo TEMPATH; ?>images/lock_vedio.png" height="200" width="200" /></a></div>
<?php
	}
}else{
?>
