...
<li><a href="uploads/photo/<?php echo $row_photo["filename"];?>" rel="prettyPhoto" title="<?php echo $row_photo["description"]==""?"无该图片描述":$row_photo["description"];?>"><img class="lazy" src="<?php echo TEMPATH; ?>images/lightbox-ico-loading.gif" data-original="uploads/photo/<?php echo $row_photo["filename"];?>" alt="<?php echo $row_photo["title"];?>" /></a></li>
</ul>
</div>
<div class="photo_show_title"><h4><?php echo $row_photo["title"];?></h4></div>
<div class="photo_show_info">
<div class="photo_show_description"><span style="color:#999">图片描述：</span><?php echo $row_photo["description"]==""?"无该图片描述":$row_photo["description"];?></div>
