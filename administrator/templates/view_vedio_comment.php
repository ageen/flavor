...
<title>VIEW VEDIO COMMENT</title>
...
<body>
<div class="view_article_comment_head"><?php echo $row_vedio["title"];?> 相关评论： <a href="view.php?mode=vedio">返回视频</a></div>
<div class="article_search">
<div class="article_time_sort">
<form action="view.php?mode=vedio_comment&id=<?php echo $id;?>" method="post" name="vedio_time_sort">
<select name="comment_sort" onchange="javascript:document.vedio_time_sort.submit();">
<?php
...
?>
<div class="no_article">暂无该视频评论！</div>
<?php
} else {
$i = 0;
...
<div class="f_detail" style="float:right;"><a href="delete.php?mode=vedio_comment&id=<?php echo $v["id"];?>" onclick="return del();" target="_self">[删除该条评论]</a></div>
</td>
</tr>
</table>
<?php
