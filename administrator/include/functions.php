...
//	$row = mysql_fetch_array($result);
	...
	if ($numrows > $limit) {
		...
		$pagelinks .= '</ul>';
		$pagelinks = "<span class='span3' style='font-weight:bold;'>共".$numrows."条记录 当前第".$page."/".$numofpages."页</span>".$pagelinks;
	} else {
		//$pagelinks = 'nothing';
		$pagelinks = "<span class='span3' style='font-weight:bold;'>共".$numrows."条记录</span>";
	}
	return $pagelinks;
}
