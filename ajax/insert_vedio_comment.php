...
$sql = "SELECT * FROM f_vedio_comment WHERE vedio_id = " . $feed["vedio_id"] . " ORDER BY publish_time DESC LIMIT 8";
$row_comments = get_rows($sql, "array");
$sql = "SELECT * FROM f_vedio_comment WHERE vedio_id = " . $feed["vedio_id"];
...
<div class="comment_more"><a href="view.php?mode=vedio_comment&id=<?php echo $feed["vedio_id"];?>">共<?php echo $comments_num;?>条评论 >></a></div>
