...
$sql = "SELECT * FROM f_photo_comment WHERE photo_id = " . $feed["photo_id"] . " ORDER BY publish_time DESC LIMIT 8";
$row_comments = get_rows($sql, "array");
$sql = "SELECT * FROM f_photo_comment WHERE photo_id = " . $feed["photo_id"];
...
<div class="comment_more"><a href="view.php?mode=photo_comment&id=<?php echo $feed["photo_id"];?>">共<?php echo $comments_num;?>条评论 >></a></div>
